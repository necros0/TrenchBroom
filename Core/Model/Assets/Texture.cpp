...
namespace TrenchBroom {
    ...
    Texture::Texture(const Mip& mip, const Palette& palette) {
    ...
    TextureCollection::TextureCollection(const string& name, Wad& wad, const Palette& palette) {
        this->name = name;
        for (int i = 0; i < wad.entries.size(); i++) {
            WadEntry& entry = wad.entries[i];
