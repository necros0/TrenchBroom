...
namespace TrenchBroom {
    ...
    public:
        ...
        BspFace(BspTextureInfo* textureInfo, vector<TVector3f>& vertices);
        TVector2f textureCoordinates(TVector3f& vertex);
    };
    ...
    public:
        ...
        int vertexCount;
        BspModel(vector<BspFace*>& faces, int vertexCount, TVector3f& center, TBoundingBox& bounds, TBoundingBox& maxBounds);
        ~BspModel();
    };
    ...
    private:
        ...
        void readVertices(istream& stream, int count, vector<TVector3f>& vertices);
