...
namespace TrenchBroom {
    ...
    MapParser::MapParser(istream& stream, const TBoundingBox& worldBounds, TextureManager& textureManager) : m_worldBounds(worldBounds), m_textureManager(textureManager) {
